...
public class EnemyAI : MonoBehaviour
{
    ...
    //how far do we want to patrol in?
    ...
    void Update()
    {
        ...
        else if (returnHome && !isHome)
        {
            ...
            {
                homeDir.Normalize();
                GetComponent<Rigidbody2D>().velocity = homeDir * patrolSpeed;
            }
        ...
        else if (patrol)
        {
            ...
            {
                //flip around, as we've patrolled too far
                patrolDirection = -displacement;
            }
            //push the enemy in the direction of the patrol
            patrolDirection.Normalize();
            GetComponent<Rigidbody2D>().velocity = patrolDirection * patrolSpeed;
        }
